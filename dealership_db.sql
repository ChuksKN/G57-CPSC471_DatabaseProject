...
CREATE TABLE `car_rental` (
  ...
  KEY `VIN` (`VIN`),
  CONSTRAINT `car_rental_ibfk_1` FOREIGN KEY (`EmployeeID`) REFERENCES `employee` (`EmployeeID`),
  CONSTRAINT `car_rental_ibfk_2` FOREIGN KEY (`CustomerID`) REFERENCES `customer` (`CustomerID`),
  CONSTRAINT `car_rental_ibfk_3` FOREIGN KEY (`VIN`) REFERENCES `car` (`VIN`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `car_sale` (
  ...
  CONSTRAINT `car_sale_ibfk_1` FOREIGN KEY (`EmployeeID`) REFERENCES `employee` (`EmployeeID`),
...
CREATE TABLE `insurance_plan` (
  ...
  CONSTRAINT `insurance_plan_ibfk_1` FOREIGN KEY (`VIN`) REFERENCES `car` (`VIN`),
  CONSTRAINT `insurance_plan_ibfk_2` FOREIGN KEY (`VIN`, `PlanNumber`) REFERENCES `drivers` (`VIN`, `PlanNumber`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rental_car` (
  ...
  CONSTRAINT `rental_car_ibfk_1` FOREIGN KEY (`VIN`) REFERENCES `car` (`VIN`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `used_car` (
  ...
  PRIMARY KEY (`VIN`),
  CONSTRAINT `used_car_ibfk_1` FOREIGN KEY (`VIN`) REFERENCES `car` (`VIN`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `used_car_sale` (
  ...
  KEY `CustomerID` (`CustomerID`),
  KEY `VIN` (`VIN`),
  CONSTRAINT `used_car_sale_ibfk_1` FOREIGN KEY (`EmployeeID`) REFERENCES `employee` (`EmployeeID`),
  CONSTRAINT `used_car_sale_ibfk_2` FOREIGN KEY (`CustomerID`) REFERENCES `customer` (`CustomerID`),
  CONSTRAINT `used_car_sale_ibfk_3` FOREIGN KEY (`VIN`) REFERENCES `car` (`VIN`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-04-03 16:44:50

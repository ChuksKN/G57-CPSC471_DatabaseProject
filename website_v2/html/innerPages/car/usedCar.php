...
<head>
    ...
    <script src="usedcar_script.js"></script>
...
<div class="rightMenuContainer">
    <section class="formThing">
        ...
        <p class="description">Manage used cars</p>
        <div class="underLine"></div>

        <div class="container">
            <button id="addUsedCarBtn" class="btn btn-primary btn-block">Add Used Car</button><br><br>
            <form id="newForm" style="margin : 0 auto;">
                ...
                <div class="form-group row">
                    <label for="DistanceTravelled" class="col-sm-2 col-form-label">Distance Travelled</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="DistanceTravelled">
                    </div>
                </div>
                <button id="addUsedCar" type="submit" class="btn btn-primary">Add Car</button><br><br>
            </form>
            ...
            <div id="updateFormDiv">
                <form id="updateForm">
                    ...
                    <div class="form-group row">
                        <label for="updateDistanceTravelled" class="col-sm-2 col-form-label">Distance Travelled</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="updateDistanceTravelled" required>
                        </div>
                    </div>
                    <button id="updateUsedCar" type="submit" class="btn btn-primary">Update Car</button>
                </form>
            </div>
            <table id="usedCarTable" class="table table-bordered table-hover">
                <thead>
                <tr><th>VIN</th>
                    <th>Manufacturer</th>
                    <th>Make</th>

...
<section>
    <div class="rightMenuContainer">
        <p class="bolderEmployee">Parts inventory</p>
        <p class="description">View parts</p>
        ...
        <div class="accountCreatorBox">
            ...
            <form name="addInformation">
                ...
                <div>
                    <label>
                        <p class="selectAdminName">Select part</p>
                ...
                <input type="text" placeholder="Search part" class="searchInput">

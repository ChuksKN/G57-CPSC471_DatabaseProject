            ...
            <li>
                <div class="selectionBox">
                    ...
                    <ul class="innerObjects"><br>
                        ...
                        <li class="pageNotSelected">
                            <a href="../../../html/innerPages/customer/viewMaintenanceRequests.php" class="otherPagesInner">
...
<section>
    <div class="rightMenuContainer">
        <p class="bolderEmployee">Rental car</p>
        <p class="description">View rental car details</p>

...
<body>
    ...
    <section>
        <div class="rightMenuContainer">
            <p class="bolderEmployee">Admin account</p>
            <p class="description">View admins</p>
            ...
            <div class="accountCreatorBox">
                ...
                <form name="addInformation">
                    ...
                    <div>
                        <label>
                            <p class="selectAdminName">Select admin</p>
                    ...
                    <input type="text" placeholder="Search admin" class="searchInput">

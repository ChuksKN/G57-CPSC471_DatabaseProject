            ...
            <li>
                <div class="notSelected">
                    ...
                    <ul class="innerObjects"><br>
                        ...
                        <a href="../../../html/innerPages/sales/accessCarRentals.php" class="otherPagesInner">
                        <li class="pageNotSelected">
                            Car rentals
...
<section>
    <div class="rightMenuContainer">
        <p class="bolderEmployee">Car sales</p>
        <p class="description">x total cars sold</p>
        ...
        <div class="accountCreatorBox">
            ...
            <form name="addInformation">
                ...
                <div>
                    <label>
                        <p class="selectAdminName">Select car sale</p>
                        <select name="adminAccount" id="adminAccount" class="dropdown">
                            <optgroup label="car sale">

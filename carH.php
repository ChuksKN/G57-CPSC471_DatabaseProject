...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="../../css/homepageStyles/carStyle.css">
...
<section>
    <div class="menuHolder">
        ...
        <ul class="nav" id="loadCategories">
            <li href="#">
                <a href="../../html/innerPages/car/carSales.php">
                    <div class="box">
                        <p class="textInBox">Sale cars</p>
            ...
            <li href="#">
                <a href="../../html/innerPages/car/carRentals.php">
                    <div class="box">
